...
/* МЕТОДЫ ВСТАВКИ созданного элемента в html. Самостоятельно или в паре с CREATEELEMENT. В том числе может использоваться и самостоятельно
...
/* Еще один метод вставки кода - insertAdjacentHTML. Универсальный 
var g33 = document.body.getElementById('toIns')
g33.insertAdjacentHTML(
    'afterend',
    `<div class="info1">
...
/* МЕТОДЫ ВСТАВКИ созданного элемента в html для insertAdjacentHTML */
...
classList.add - добавить новый класс в дополнение к существующему
classList.remove - удалить класс
classList.toggle - добавить класс, если его нет, а если есть - удалить
classList.contains - проверить наличие класса, возвращает true / false
*/


/* CКРЫТЬ  и  ПОКАЗАТЬ элемент */
const yorik = document.querySelector('.orange-info')
